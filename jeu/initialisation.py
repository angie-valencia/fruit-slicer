...
def charger_toutes_les_images():
    ...
    for nom, chemin in IMAGES.items():
        if nom == "fond" or nom == "image_accueil":
            ...
            # On le charge en grand (ex: 200x200)
            images_chargees[nom] = charger_image(chemin, (200, 200))
        elif nom == "coeur":
            images_chargees[nom] = charger_image(chemin, (50, 50))
        else:
            # Pour les fruits et bombes
