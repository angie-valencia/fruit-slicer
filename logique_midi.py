# ============================================
# LOGIQUE DU JEU - MODE MIDI
# Version alternative avec touches dynamiques
# ============================================
...
from constantes import (
    ...
    HAUTEUR_FENETRE, GRAVITE_MIDI,
    VITESSE_INITIALE_Y_MIN_MIDI, VITESSE_INITIALE_Y_MAX_MIDI
)

class ObjetMIDI:
    """
    Classe pour les objets en mode MIDI.
    Différence : gère les modes facile/difficile avec touches dynamiques
    """
    ...
    def __init__(self, colonne, type_objet, mode="difficile"):
        ...
        self.vitesse_y = random.uniform(VITESSE_INITIALE_Y_MIN_MIDI, VITESSE_INITIALE_Y_MAX_MIDI)
        self.actif = True
    ...
    def mettre_a_jour(self):
        ...
        # Applique la gravité MIDI (plus simple)
        self.vitesse_y += GRAVITE_MIDI
